<script lang="ts">
	...
	const isOver = $derived(enterCount > 0);
...
{#if isOver}
	...
	<div
		class="fixed inset-0 z-[100] bg-tw-darkblue/90
		       flex flex-col items-center justify-center border-4 border-dashed border-tw-neon/50 m-4 rounded-3xl
		       transition-all duration-200 pointer-events-none"
	>
		<div class="flex flex-col items-center gap-6 animate-bounce pointer-events-none">
